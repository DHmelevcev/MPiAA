...
TEST_CASE("Empty array") {
    ...
    CHECK_FALSE(has_duplicates_set(data));
    CHECK_FALSE(has_duplicates_sort(data));
    CHECK(sorted(get_duplicates(data)) == std::vector<int> {});
    CHECK(sorted(get_duplicates_set(data)) == std::vector<int> {});
    CHECK(sorted(get_duplicates_sort(data)) == std::vector<int> {});
}
...
TEST_CASE("Many elements, one duplicate") {
    ...
    CHECK(has_duplicates_set(data));
    CHECK(has_duplicates_sort(data));
    CHECK(sorted(get_duplicates(data)) == std::vector<int> {2});
    CHECK(sorted(get_duplicates_set(data)) == std::vector<int> {2});
    CHECK(sorted(get_duplicates_sort(data)) == std::vector<int> {2});
}
...
TEST_CASE("Many elements, many duplicates") {
    ...
    CHECK(sorted(get_duplicates_set(data)) == std::vector<int> {-3, 1, 2});
    CHECK(sorted(get_duplicates_sort(data)) == std::vector<int> {-3, 1, 2});
}
...
TEST_CASE("Single duplicated elem") {
    ...
    CHECK(sorted(get_duplicates_set(data)) == std::vector<int> {4});
    CHECK(sorted(get_duplicates_sort(data)) == std::vector<int> {4});
}